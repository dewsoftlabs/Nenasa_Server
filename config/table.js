...
const tableInfo = [
  ...
  },
  {
    ...
    fields: [
      { name: "collection_id", type: "INT AUTO_INCREMENT PRIMARY KEY" },
      { name: "loan_id", type: "INT(255)" },
      { name: "balance", type: "FLOAT" },
      { name: "paid_installements", type: "INT(255)" },
      { name: "branchid", type: "INT(5)" },
      { name: "userid", type: "INT(5)" },
      { name: "status", type: "INT(10)" },
      { name: "trndate", type: "DATETIME" },
      { name: "is_delete", type: "INT(5)" },
    ],
  },
  {
    tableName: "installement",
    fields: [
      { name: "installement_id", type: "INT AUTO_INCREMENT PRIMARY KEY" },
      { name: "collection_id", type: "INT(255)" },
      { name: "installment_desc", type: "VARCHAR(255)" },
      { name: "installement_amount", type: "FLOAT" },
      { name: "paid_amount", type: "FLOAT" },
      { name: "installement_status", type: "INT(10)" },
      { name: "installement_paidDate", type: "DATETIME" },
      { name: "userid", type: "INT(5)" },
      { name: "is_delete", type: "INT(5)" },
    ],
  },
  {
    ...
    fields: [
      ...
      { name: "hold_endDate", type: "VARCHAR(255)" },
      { name: "branchid", type: "INT(5)" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "total_payamount", type: "FLOAT" },
