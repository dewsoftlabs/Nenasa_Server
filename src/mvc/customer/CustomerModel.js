...
const customerModel = {
    ...
    addCustomer(customer, callback) {
        ...
        const values = [customer_name,customer_phone,customer_email, customer_address , customer_gender , customer_nic , branchIdInt , trndate, activeValues, defaultValues, routeid];
        console.log(values)
